...
export const UserItem = () => {
  ...
  return (
    <DropdownMenu>
      ...
      <DropdownMenuContent className='w-80 bg-secondary' align='start' alignOffset={11} forceMount>
        <div className='flex flex-col space-y-4 p-2'>
          <div className='flex items-center gap-x-2'>
            <div className='rouneded-md bg-secondary p-1'>
              <Avatar className='h-8 w-8'>
                <AvatarImage className='rounded-full' src={user?.imageUrl} />
              </Avatar>
            </div>
            <div className='space-y-1'>
              <p className='text-sm text-[#535353] dark:text-[#f0ecec] line-clamp-1 font-bold mb-0'>{user?.fullName}&apos;s Jotion</p>
