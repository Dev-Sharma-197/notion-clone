...
const Toolbar = ({ initialData, preview }: ToolbarProps) => {
  ...
  return (
    <div className='pl-[54px] group relative'>
      ...
      {!!initialData.icon && preview && <p className='text-6xl pt-5'>{initialData.icon}</p>}
      ...
      {isEditing && !preview ? (
        ...
        <div onClick={enableInput} className='pb-[11.5px] text-5xl break-words font-bold outline-none text-[#3F3F3F] dark:text-[#CFCFCF]'>
          {initialData.title}
        </div>
      )}
    </div>
